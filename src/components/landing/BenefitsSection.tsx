  ...
  return (
    <section className="py-16 px-1 bg-white">
      <div className="container mx-auto text-center max-w-5xl">
        ...
        <h2 className="text-3xl md:text-4xl font-bold mb-12 text-[#002A5C]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100 flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-[#002A5C]">Comissão Atrativa</h3>
          ...
          <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100 flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-[#002A5C]">Zero Preocupação com Execução</h3>
          ...
          <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100 flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-[#002A5C]">Entrega Rápida e Qualidade Garantida</h3>
          ...
          <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100 flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-[#002A5C]">Suporte Completo</h3>
          ...
          <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100 flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-[#002A5C]">Soluções Escaláveis</h3>
